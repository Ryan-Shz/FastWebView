...
FastWebView通过自定义本地缓存的方式，突破原生WebView缓存限制，提供多种缓存模式，支持预加载和离线加载，并友好的支持离线包方案，可以大幅提升H5加载速度。经过千万级用户的项目实践数据证明，优化效果达到50%以上。
...
```
implementation "com.ryan.github:fastwebview:1.0.2"
```
